...
public class SNGF {
	 ...
	 */
	public Compte getVoyageur(String loginVoyageur, String passVoyageur)
		 throws CompteIntrouvableException{
		Compte voyageur = voyageurDao.trouverVoyageur(loginVoyageur, passVoyageur);
		return voyageur;
	}
	 ...
	 */
	public Reservation getBillet(int numeroBillet) throws IntrouvableException {
	 ...
	 */
	public List<Reservation> getBillets(Compte voyageur) {
	 ...
	 */
	public Vol getDepart(int numeroDepart) throws IntrouvableException {
	 ...
	 */
	public Vol getDepart(Reservation billet) throws IntrouvableException {
	 ...
	 */
	public List<Vol> getDeparts(String villeDepart,String villeDestination,String dateDebut,String dateFin){
	 ...
	 */
	public Compte addVoyageur(String loginVoyageur, String passVoyageur, String nomVoyageur, String adresseVoyageur) 
			throws CompteExisteDejaException {
		Compte voyageur = new Compte(loginVoyageur, passVoyageur, nomVoyageur, adresseVoyageur);
	 ...
	 */
	public void addBillet(Vol depart, Compte voyageur) {
	 ...
	 */
	public void removeBillet(Reservation billet) {
